...
const ModelInner: FC<ModelInnerProps> = ({
  ...
  const content = useMemo<THREE.Object3D | null>(() => {
    ...
    if (ext === 'obj') return (useLoader(OBJLoader, url) as THREE.Object3D).clone();
  ...
  return (
    <div
      style={{
        ...
        backgroundColor: isTransparentBg ? 'transparent' : backgroundColor
      }}
    >
      ...
      <Canvas
        shadows
        frameloop="demand"
        gl={{ preserveDrawingBuffer: true, alpha: isTransparentBg }}
        ...
        style={{
          touchAction: 'pan-y pinch-zoom',
          background: isTransparentBg ? 'transparent' : backgroundColor
        }}
      >
